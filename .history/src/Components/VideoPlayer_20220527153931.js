        ...
        await axios.get(urlVideoId)
            .then((data) => {
                ...
                if (data) {
                    ...
                    let urlVideoStat = `${apiVideoStat.api}${data.data.items[0].id.videoId}&key=${apiVideoId.key}&part=snippet,statistics&fields=items(id,snippet&maxResults=50,statistics)`
    ...
    return (
        <div className='video-player-body'>
            ...
            <div className='iframe-and-videoCards-container' >
                ...
                {/* Display video cards */}
                <VideoCards videoId={videoId} videoLink={videoLink} videoStat={videoStat} />
