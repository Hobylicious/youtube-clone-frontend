		...
		return (
			<div className="videosContainer">
				...
				< div className='single-card' key={index} >
						...
						<img className='image' src={`https://i.ytimg.com/vi/RS9PMaKJHQ4/hq720.jpg?sqp=-oaymwEjCOgCEMoBSFryq4qpAxUIARUAAAAAGAElAADIQj0AgKJDeAE=&rs=AOn4CLCQz3jKppzDMetjr2KQgeuRmX-0kw`} height='60' alt='images' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${video.id}` }} />
