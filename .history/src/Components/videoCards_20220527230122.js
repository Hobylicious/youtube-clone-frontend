				...
				< div className='single-card' key={0} >
					< div className='single-card' key={0} ></div>
						...
						<div className="video-description">
							...
							<a className='channel-id' href={`https://www.youtube.com/channel/${videos[0].author.channelID}`}>Channel: {video.author.name.toLowerCase().charAt(0).toUpperCase()}{video.author.name.substring(1).toLowerCase()}</a>
