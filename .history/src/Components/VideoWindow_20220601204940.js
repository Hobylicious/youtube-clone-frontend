...
function VideoWindow({ videos }) {
	...
	// To capture the information of each video playing video, "videos" will be filtered to return the video that includes the id is equal to the played video's id.
