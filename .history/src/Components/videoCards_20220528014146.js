			...
			<div className="videosContainer">
				...
				< div className='single-card' key={index} >
						...
						<div className="video-description">
							...
							<a className='channel-id' href={`https://www.youtube.com/channel/${video.author.channelID}`}>Channel: {videos[0].author.name.toLowerCase().charAt(0).toUpperCase()}{videos[0].author.name.substring(1).toLowerCase()}</a>
