...
<Link key={3} to='/videoPlayer'>
					< div className='single-card-home single-card-player ' key={index} >
						...
						<img className='image-home' src={video.snippet.thumbnails.high.url} height='60' alt='images' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}` }} />
