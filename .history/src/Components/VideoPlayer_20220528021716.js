...
function VideoPlayer() {
    ...
    let apiVideoId = {
        ...
        api: `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=&q=`
    };
    ...
    return (
        <div className='video-player-body'>
            ...
            <div className='iframe-and-videoCards-container' >
                ...
                {/* Display video cards */}
                <VideoCards videoId={videoId} videoLink={videos} videoStat={videoStat} likes={likes} views={views} />
