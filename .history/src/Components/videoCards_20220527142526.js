			...
			<div className="videosContainer">
				{videoLink.data.items.map((video, index) => (
					...
					< div className='single-card' key={index} >
						...
						<img className='image' src={video.snippet.thumbnails.high.url} heialt='images' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}` }} />
