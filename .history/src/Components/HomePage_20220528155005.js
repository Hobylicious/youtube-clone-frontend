...
function HomePage() {
    ...
    youtubesearchapi.GetPlaylistData(<Playlist RDCLAK5uy_kmq8ZD0NbHbKkZZ6frtlEjd8khfeZrAd0Id>,[limit number])
    console.log(youtubesearchapi.GetChannelById(youtubesearchapi.GetPlaylistData(<Playlist  >,[10])  ) )
