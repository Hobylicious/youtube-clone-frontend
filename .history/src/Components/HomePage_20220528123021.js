...
fetch(`https://youtube-search-results.p.rapidapi.com/youtube-search/?q=${searchedString}`, options)
    ...
    return (
        <div className='video-player-body'>
            ...
            <div className='iframe-and-videoCards-container' >
                ...
                {/* Display video cards */}
                <VideoCards videoId={videoId} videos={videos} suggestedVideos={sugge} />
