...
function HomePage() {
    ...
    console.log(youtubesearchapi.GetChannelById(youtubesearchapi.GetPlaylistData(<Playlist Id>,[10])   RDCLAK5uy_kmq8ZD0NbHbKkZZ6frtlEjd8khfeZrAd0 & start_radio=1 & rv=b07caYNoBXQ)
