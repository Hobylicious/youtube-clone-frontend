...
// <div className='video-window'
			...
			<div className="videosContainer">
				...
				< div className='single-card' key={1} >

					<img className='image' src={video[0].thumbnails.url} height='60' alt='images' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${video.id}` }} />
