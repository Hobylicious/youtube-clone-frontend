				...
				<ul className="items">
					{videoLink.data.items.map((video, index) => (
						...
						<li className="item" key={index}>
							...
							<div>
								<b>
									<a href=`https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}`>{video.snippet.title}</a></b>
							...
							<img alt="" href=`https://www.youtube.com/watch_popup?v=${${videoId[index].id.videoId` src={videoStatistics.snippet.thumbnails.url} height="75" />
