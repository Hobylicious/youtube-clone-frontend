...
// <div className='video-window'
			...
			<div className="videosContainer">
				...
				< div className='single-card' key={index} >
					...
					<img className='image' src={videos.thumbnails[1].url} height='60' alt='images' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${videos[0].id}` }} />
