					...
					<Link className='link' to='/videoPlayer'>
						< div className='single-card' key={index} >
							...
							<div className="video-description">
								...
								<a className='channel-id' href={`https://www.youtube.com/channel/${video.achannelID}`} target='_blabk'>Channel: {video.author.name.toLowerCase().charAt(0).toUpperCase()}{video.video.author.name.substring(1).toLowerCase()}</a>
