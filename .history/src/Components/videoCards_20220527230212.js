			...
			<div className="videosContainer">
				...
				< div className='single-card' key={0} >
					< div className='single-card' key={0} ></div>
						...
						<img className='image' src={videos[0].thumbnails[1].url} height='60' alt='images' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${videos[].id}` }} />
