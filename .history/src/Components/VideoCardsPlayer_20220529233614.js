...
const VideoCards = ({ videoss, suggestedVodeos }) => {
						...
						<Link className='link' to={`/videoPlayer/${video.id}`}>
							...
							< div className='single-card' key={index} >
								...
								<div className="video-description">
									...
									<a className='channel-id' href={`https://www.youtube.com/channel/${video.author.channelID}`} target='_blank' rel='noreferrer'>Author: {video.author.name}</a>
