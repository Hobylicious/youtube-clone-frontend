	...
	if (videoLink.length < 1) {
		...
		return (
			<div className="videosContainer">
						...
						<img className='single-card' src={video.snippet.thumbnails.default.url} alt='images' width="120" height="90" onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=AmericanFlag` }} />
