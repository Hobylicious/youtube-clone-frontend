				...
				{videoLink.data.items.map((video, index) => (
					...
					< div className='single-card' key={index} >
						...
						<div className="video-description">
							...
							<a className='channel-id' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/channel/UCo7hxTE3HeKVuu4K7N0dMYQ` }} </p>
						...
						// href= {`https://www.youtube.com/channel/${video.snippet.channelId}`}>Channel: {video.snippet.channelTitle}
						</div>
					</div>
