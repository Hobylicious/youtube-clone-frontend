						...
						<Link className='link' to={`/videoPlayer/${video.id}`}>
							< div className='single-card-player' key={index} >
								...
								<div className="video-description">
									<p className='title' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${video.id}` }}>Title: {capitalizeFirstLettervideo.title}</p>
