	...
	return (videoObject.type === 'video' &&
		<div className='like-dislike-playlist-container'>
			<div className='title-date-channel'>
				...
				<img className="playing-video-avatar" src={videoObject.author.avatars[0].url} alt='authorAvatar' /><p className='playing-video-channel'>{videoObject.author.name.charAt(0).toUpperCase()}{videoObject.author.name.substring(1).toLowerCase()}</p>
			</div>
