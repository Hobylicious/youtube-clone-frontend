...
function HomePage() {
    ...
    const [searchedString, setSearchedString] = useState('Ha');
    ...
    return (
        <div className='video-player-body'>
            ...
            <div className='iframe-and-videoCards-container' >
                ...
                {/* Display video cards */}
                <VideoCardsHome videoId={videoId} videos={videos} suggestedVodeos={suggestedVideos} videoStat={videoStat} views={views} likes={likes} />
