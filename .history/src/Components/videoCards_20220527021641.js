			...
			<div className="videosContainer">
				{videoLink.data.items.map((video, index) => (
					...
					< div key={index} >
						...
						<div className='card'>
							<img className='single-card' src={video.snippet.thumbnails.high.url} alt='images' width="200" height="100" onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}` }} />
						</div>
