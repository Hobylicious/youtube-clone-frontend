...
const VideoCards = ({ videos, suggestedVodeos }) => {
	...
	let arrayPlaylistFunc = (id) => {
		arrayPlaylist.push(setAddedVideo(`https://www.youtube.com/watch_popup?v=${id}`)) 
	...
	// This return all clickable thumbnails cards.
		...
		return (
			...
			</div>{/* Pass the arraylist function to capture all added videos */}
				<SearchForm arrayPlaylistFunc = {arrayPlaylistFunc}/>
