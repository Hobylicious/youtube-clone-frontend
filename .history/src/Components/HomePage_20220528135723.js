            ...
            .then((data) => {
                ...
                if (data.data) {
                    ...
                    data.data.items.forEach(item => {
                        ...
                        let urlVideoStat = `https://developers.google.com/apis-explorer/#p/youtube/v3/youtube.search.list?part=snippet&order=viewCount&q=skateboarding+dog&type=video
