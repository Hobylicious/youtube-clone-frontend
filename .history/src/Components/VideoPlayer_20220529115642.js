        ...
        <div className='video-player-body'>
            ...
            <div className='iframe-and-videoCards-container' >
                ...
                <VideoWindow
                    ...
                    // videoStat={videoStat}
                    // result={result}
                    videos={videos} suggestedVodeos={suggestedVideos}
                />

                {/* Display video cards */}
                <VideoCards videoId={videoId} videos={videos} suggestedVodeos={suggestedVideos} videoStat={videoStat} views={views} likes={likes} />
