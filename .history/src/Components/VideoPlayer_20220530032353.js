...
function VideoPlayer({ getIndex }) {
    ...
    // Decreament likes count by 1, and don't let likesDislikesCount go negative
    const decrement = () => {
        likesDislikesCount > 0 ?
        setLikesDislikesCount(likesDislikesCount + 1) : setLikesDislikesCount(0)
    }
        ...
        <div className='video-player-body'>
            ...
            <div className='iframe-and-videoCards-container' >
                ...
                <LikesAddPlaylist // {/* Pass the arraylist function to capture all added videos */}
                    arrayPlaylistFunc={arrayPlaylistFunc}  increment={increment} decrement={decrement} />
