					...
					< div key={index} >
						...
						<div className='video-description'>
							...
							<div className="meta">
								...
								<p onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}` }}>Uploaded at: {videoStat[index].snippet.publishedAt.subString(5, 7)}/{videoStat[index].snippet.publishedAt.subString(8, )}</p>
