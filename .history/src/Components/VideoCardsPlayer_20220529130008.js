				...
				{videos.map((video, index) => (
					<Link className='link' to='/videoPlayer'>
						< div className='single-card' key={index} >
							...
							<img className='image' src={video.thumbnails[0].url} height='60' alt='images' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${video.author.id}` }} />
