...
function HomePage() {
    ...
    return (
        <div className='video-player-body'>
            ...
            <Routes>
                <Route path='/' element={<HomePage videoId={videoId} videos={videos} videoStat={videoStat} views={views} likes={likes} />} />
                <Route path='/videoPlayer' element={<VideoPla videoId={videoId} videos={videos} videoStat={videoStat} views={views} likes={likes} />} />
