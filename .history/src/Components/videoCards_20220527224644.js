...
const VideoCards = ({ videos, setSuggestedVideos }) => {
	...
	// 						<a className='channel-id' href={`https://www.youtube.com/channel/${video.auchannelID}`}>Channel: {video.snippet.channelTitle.toLowerCase().charAt(0).toUpperCase()}{video.snippet.channelTitle.substring(1).toLowerCase()}</a>
