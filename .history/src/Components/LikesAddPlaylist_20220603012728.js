	...
	return (videoObject.type === 'video' &&
		<div className='like-dislike-playlist-container'>
			...
			<div className='views-container'>
				<p className='playing-video-title'>{viewsFunc(videoObject.views)}</p>
				<div className='views-icon' >
					<ImEye className='eye playing-video-title' />
					Views
				</div>
			</div>

			<div className='likes-container className='playing-video-title''>
			...
			<div className='dislikes-container'>
				<p className='playing-video-title' >{likesDisLikeCount}</p>
				<div className='dislike-icon playing-video-title'>
			...
			<div className='add-to-playlist'>
				<BiAddToQueue className='add-to-playlist-icon playing-video-title' onClick={() => arrayPlaylistFunc(id)
				} />
				Add to playlist
			</div>
