        ...
        await axios.get(urlVideoId)
            .then((data) => {
                ...
                // Check if the result fron the first API is not empty.
                    ...
                    let urlVideoStat = `${apiVideoStat.api}${data.data.items[0].id.videoId}&key=${apiVideoId.key}&part=snippet,contentDetails, fileDetails, player,  statistics&fields=items(id,snippet,statistics)`
