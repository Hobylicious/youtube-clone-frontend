...
// This holds seggested videos
    ...
    const [searchedString, setSearchedString] = useState('Harmoni');
    ...
    return (
        <div className='video-player-body'>
            ...
            <div className='iframe-and-videoCards-container' >
                ...
                {/* Display video cards */}
                <VideoCardsPlayer videoId={videoId} videos={videos} suggestedVodeos={suggestedVideos} videoStat={videoStat} views={views} likes={likes} />
