									...
									<div className='logo-cannel-views-posted-duration' >
										<div className='channel-info' >
											<div className='logo-channelName'>
												...
												<a className='channel-id' href={`https://www.youtube.com/channel/${capitalizeFirstLettervideo.author.channelID}`} target='_blank' rel='noreferrer'>{video.author.name}</a>
											</div>
