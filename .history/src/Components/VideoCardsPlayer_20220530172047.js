							...
							< div className='single-card' key={index} >
								...
								<div className="video-description">
									...
									<div className='channel' >
										<img src={`${video.author.avatar[0].url}`} alt="" /><a className='channel-id' href={`https://www.youtube.com/channel/${video.author.channelID}`} target='_blank' rel='noreferrer'>Channel: {video.author.name}</a>
									</div>
