				...
				{videoLink.data.items.map((video, index) => (
					...
					< div key={index} >
						...
						<div className='single-card'>
								<img className='image' src={video.snippet.thumbnails.high.url} alt='images' width="150" height="150" onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}` }} />
