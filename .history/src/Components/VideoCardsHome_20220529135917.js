...
// This component receives two objects: videoId has thumbnails and and videoIds..., and suggestedVodeos has statics information like views count, likes, dislikes...
const VideoCardsHome = ({ suggestedVodeos }) => {

	// const[url, setUrl] = useState()

 console.log(suggestedVodeos)
	// { videoId, suggestedVodeos, suggestedVodeostat, likes, views}
	...
	// else {
		return (
			<div className="cards car" >
				{suggestedVodeos.length > 0 && suggestedVodeos.map((video, index) => (
