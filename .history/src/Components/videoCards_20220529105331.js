	...
	if (videos.length < 1) {
		console.log("No result found")
		{
			< div className="modal" tabindex="-1" role="dialog" >
				<div classclassName="modal-dialog" role="document">
					<div className="modal-content">
						<div classclassName="modal-header">
							<h5 classclassName="modal-title">Modal title</h5>
						...
						<div class="modal-footer">
							<button type="button" ="btn btn-primary">Save changes</button>
