	...
	// This return all clickable thumbnails cards.
		...
		return (
			...
			// </li>
						...
						// < div key={index} >
						// 	<img className='single-card' src={video.snippet.thumbnails.default.url} alt='images' width="200" height="120" onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=$</div>{videoId[index].id.videoId}` }} />
						// </div>
	}
