...
function HomePage() {
    ...
    // Declare an object to hold data return from the second API call. Initialize it to an empty array.
    const [suggestedVideos, setuggestedVideos] = useState([]);
    ...
    fetch(`https://youtube-search-results.p.rapidapi.com/youtube-search/?q=harmonize`, options)
