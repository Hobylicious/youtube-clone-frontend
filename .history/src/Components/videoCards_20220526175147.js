...
const VideoCards = ({ videoId, videoLink }) => {
	...
	// This return all clickable thumbnails cards.
		...
		return (
			...
			//                                          <div>
			//                                              <b><a href= https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}>{videoId[index].snippet.title}</a></b>
			//                                              <p>{videoId[index].snippet.description}</p>
			// //                                         </div>
			//                                         <ul className="meta">
			//                                             <li>By: <a href=`https://www.youtube.com/channel/${videoId[index].snippet.channelId}`>{videoId[index].snippet.title}</a></li>
			...
			//                 }
					...
					// 	<div>
					// 		<b>
					// 			<a href= https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}>{videoId[index].snippet.title}
					// 			</a>
					...
					// < div key={index} >
					// 	<img className='single-card' src={video.snippet.thumbnails.default.url} alt='images' width="200" height="120" onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}` }} />
					// </div>
				))}
...
// alt='images' width="120" height="90" 