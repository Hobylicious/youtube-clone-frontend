...
function Auth() {
  ...
  const register = () => {
    fetch('https://youtube-clone-backend-ga.herokuapp.com/api/user/register', {
      method: 'POST',
      headers: {
  ...
  const getUser = () => {
    Axios({
      method: "GET",
      withCredentials: true,
      url: "https://youtube-clone-backend-ga.herokuapp.com/api/user/user",
    }).then((res) => {
