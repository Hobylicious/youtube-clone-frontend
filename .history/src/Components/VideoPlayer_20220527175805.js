...
function VideoPlayer() {
    ...
    async function getSearchedData(searchedString) {
        ...
        let urlVideoId = GET https://youtube.googleapis.com/youtube/v3/search?part=snippet&part=statistics&forDeveloper=true&maxResults=100&order=date&safeSearch=moderate&videoCaption=any&videoDefinition=any&videoDimension=any&videoDuration=any&videoEmbeddable=any&videoType=any&prettyPrint=true&quotaUser=5000000&alt=json&key=[YOUR_API_KEY] HTTP/1.1
