...
const VideoCards = ({ videos, setSuggestedVideos }) => {
	...
	// 					<img className='image' src={video.} height= '60'alt='images' onClick={() => { document.getElementsByTagName('iframe')[0].src = `https://www.youtube.com/watch_popup?v=${videoId[index].id.videoId}` }} />
