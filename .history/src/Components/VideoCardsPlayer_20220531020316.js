									...
									<div className='logo-cannel-views-posted-duration' >
										<div className='channel-info' >
											<div className='logo-channelName'>
												...
												<a className='channel-id' href={`https://www.youtube.com/channel/${titleCase(video.author.channelID)}`} target='_blank' rel='noreferrer'>{titleCase(strvideo.author.name)}</a>
											</div>
