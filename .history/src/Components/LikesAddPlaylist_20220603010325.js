		...
		return ( videoObject.type === 'video' &&
			<div className='like-dislike-playlist-container'>
				...
				<div className='title-date-channel'>
					...
					<p className='playing-video-channel'>`{videoObject.author.name.charAt(0).toUpperCase()}{videoObject.author.name.substring(1).toUpperCase()}`</p>
					<img className="playing-video-avatar" src={videoObject.author.avatars[0].url} alt='' />
				</div>
