...
export default function VideoWindow({ videoId, videoLink, videoStat }) {
	...
	if (videoId.length < 1) {
		...
		return (
			...
			<>
				<iframe title='video' width="420" height="315" src={url} frameborder="0" allowfullscreen></iframe>
		...
		return (
			...
			<>
				<div>
					<iframe title='ra' width="630" height="315" src={url} frameborder="0" allowfullscreen></iframe>
				</div>
			</>
		)
	}
